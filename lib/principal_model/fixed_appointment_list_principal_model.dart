class FixedAppointmentListModel {
  String? statuscode;
  String? message;
  List<FixedAppointmentData>? data;

  FixedAppointmentListModel({this.statuscode, this.message, this.data});

  FixedAppointmentListModel.fromJson(Map<String, dynamic> json) {
    statuscode = json['statuscode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <FixedAppointmentData>[];
      json['data'].forEach((v) {
        data!.add(new FixedAppointmentData.fromJson(v));
      });
    }
  }
...
class FixedAppointmentData {
  ...
  FixedAppointmentData.fromJson(Map<String, dynamic> json) {
    id = json['Id'];
