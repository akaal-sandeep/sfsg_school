class TeacherBagComponentModel {
  String? statuscode;
  String? message;
  List<Data>? data;

  TeacherBagComponentModel({this.statuscode, this.message, this.data});

  TeacherBagComponentModel.fromJson(Map<String, dynamic> json) {
