...
class _StudentAttendanceSummaryState extends State<StudentAttendanceSummary> {
  ...
  Widget _rowTextFun({title, subTitle, index}) {
    String image = title.toString().contains("Total Students in Class")
        ? Assets.iconsTotalStudentNew
        : title.toString().contains("Total Present")
        ? Assets.iconsPresentStudentNew
        : title.toString().contains("Total Absent")
        ? Assets.iconsAbsentStudentNew
        : Assets.iconsPendingStudentNew;
    ...
    return Expanded(
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: Colors.white, boxShadow: myShadow,borderRadius: BorderRadius.circular(10)),
