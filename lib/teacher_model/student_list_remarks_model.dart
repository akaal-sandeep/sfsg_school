class StudentListForRemarksModel {
  String? statuscode;
  String? message;
  List<Data>? data;

  StudentListForRemarksModel({this.statuscode, this.message, this.data});

  StudentListForRemarksModel.fromJson(Map<String, dynamic> json) {
